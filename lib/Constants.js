...
export const Currencies = {
  ...
  INR: new Currency("INR", 2, "Indian Rupee"),
};
...
export const PaymentMethods = {
  ...
  PayPalHU2: new PaymentMethod("PayPalHU2", "PayPalHU2"),
  StripeHU2: new PaymentMethod("StripeHU2", "StripeHU2"),
  StripeHU3: new PaymentMethod("StripeHU3", "StripeHU3"),
};
