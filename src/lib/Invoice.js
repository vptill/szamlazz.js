...
class Invoice {
  constructor(options) {
    this._options = {};
    this._options.issueDate = options.issueDate || new Date(moment.tz(moment(), "Europe/Budapest").format("YYYY-MM-DD HH:mm:ss"));
    this._options.fulfillmentDate = options.fulfillmentDate || new Date(moment.tz(moment(), "Europe/Budapest").format("YYYY-MM-DD HH:mm:ss"));
    this._options.dueDate = options.dueDate || new Date(moment.tz(moment(), "Europe/Budapest").format("YYYY-MM-DD HH:mm:ss"));
